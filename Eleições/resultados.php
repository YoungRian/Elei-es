    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php
                ...
                $queryContagem = $conexao->query("SELECT vot_escolhido, COUNT(*) as total 
                                                FROM tb_voto 
                                                GROUP BY vot_escolhido");
                ...
                if($queryContagem === false) {
                    ...
                    foreach ($resultados as $resultado) {
                        ...
                        $totalVotos = $resultado['total'];
                
                        echo "<tr><td>Votos para '$opcao': $totalVotos<td/></tr><br>";
                    }
                }
                $conexao->close();
            ?> 
